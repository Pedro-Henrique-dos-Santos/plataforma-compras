...
export const REQUIRED_TENANT_RELATIONS = [
  ...
  {
    name: 'purchase_invoice_links_org_purchase_fkey',
    tableName: 'purchase_invoice_links',
    referencedTable: 'purchases',
    sourceColumns: ['organization_id', 'purchase_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
  ...
  {
    name: 'purchase_invoice_links_org_invoice_fkey',
    tableName: 'purchase_invoice_links',
    referencedTable: 'invoice_documents',
    sourceColumns: ['organization_id', 'invoice_document_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
    deleteSetColumns: [],
  },
  {
    name: 'fiscal_document_items_org_document_fkey',
    tableName: 'fiscal_document_items',
    referencedTable: 'invoice_documents',
    sourceColumns: ['organization_id', 'invoice_document_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
  ...
  {
    name: 'fiscal_document_items_org_purchase_item_fkey',
    tableName: 'fiscal_document_items',
    referencedTable: 'purchase_items',
    sourceColumns: ['organization_id', 'matched_purchase_item_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'NO ACTION',
    deleteSetColumns: [],
  },
  {
    name: 'goods_receipts_org_purchase_fkey',
  ...
  {
    name: 'goods_receipt_items_org_receipt_fkey',
    tableName: 'goods_receipt_items',
    referencedTable: 'goods_receipts',
    sourceColumns: ['organization_id', 'receipt_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
    deleteSetColumns: [],
  },
  {
    name: 'goods_receipt_items_org_purchase_item_fkey',
    tableName: 'goods_receipt_items',
    referencedTable: 'purchase_items',
    sourceColumns: ['organization_id', 'purchase_item_id'],
    targetColumns: ['organization_id', 'id'],
  ...
  {
    name: 'goods_receipt_items_org_invoice_item_fkey',
    tableName: 'goods_receipt_items',
    referencedTable: 'fiscal_document_items',
    sourceColumns: ['organization_id', 'invoice_document_item_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'NO ACTION',
    deleteSetColumns: [],
  },
  {
    name: 'receipt_responsibilities_org_cost_center_fkey',
    tableName: 'receipt_responsibilities',
    referencedTable: 'cost_centers',
    sourceColumns: ['organization_id', 'cost_center_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'NO ACTION',
  ...
  {
    name: 'payment_rule_approvers_org_rule_fkey',
    tableName: 'payment_approval_rule_approvers',
    referencedTable: 'payment_approval_rules',
    sourceColumns: ['organization_id', 'rule_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
    deleteSetColumns: [],
  ...
  {
    name: 'payment_requests_org_purchase_fkey',
  ...
  {
    name: 'payment_requests_org_rule_fkey',
    tableName: 'payment_approval_requests',
    referencedTable: 'payment_approval_rules',
    sourceColumns: ['organization_id', 'rule_id'],
    targetColumns: ['organization_id', 'id'],
  ...
  {
    name: 'payment_participants_org_request_fkey',
    tableName: 'payment_approval_participants',
    referencedTable: 'payment_approval_requests',
    sourceColumns: ['organization_id', 'request_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
    deleteSetColumns: [],
  ...
  {
    name: 'payment_titles_org_request_fkey',
    tableName: 'payment_approval_titles',
    referencedTable: 'payment_approval_requests',
    sourceColumns: ['organization_id', 'request_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
  ...
  {
    name: 'payment_titles_org_installment_fkey',
    tableName: 'payment_approval_titles',
    referencedTable: 'installments',
    sourceColumns: ['organization_id', 'installment_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
    deleteSetColumns: [],
  },
  {
    name: 'payment_instructions_org_installment_fkey',
    tableName: 'payment_instruction_snapshots',
    referencedTable: 'installments',
    sourceColumns: ['organization_id', 'installment_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'CASCADE',
  ...
  {
    name: 'payment_settlements_org_installment_fkey',
  ...
  {
    name: 'installments_org_fiscal_document_fkey',
    tableName: 'installments',
    referencedTable: 'invoice_documents',
    sourceColumns: ['organization_id', 'fiscal_document_id'],
    targetColumns: ['organization_id', 'id'],
    deleteAction: 'NO ACTION',
    deleteSetColumns: [],
  },
