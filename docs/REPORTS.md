...
Os testes cobrem contratos, periodo invertido, consolidacao dos rateios, itens sem classificacao e protecao da exportacao. A homologacao deve comparar o total filtrado com a planilha de origem antes da virada para PostgreSQL.
